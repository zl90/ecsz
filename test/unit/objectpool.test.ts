...
import { Component, World, Types, ObjectPool } from "../../src/index";

test("Detecting Pool", (t: any) => {
    var world = new World();
    ...
    t.true(world.componentsManager.getComponentsPool(NoPoolComponent) === undefined);
    t.true(world.componentsManager.getComponentsPool(PoolComponent) instanceof ObjectPool);
    t.is(world.componentsManager.getComponentsPool(CustomPoolComponent), customPool);
});

test("ObjectPool", (t: any) => {
    var id = 0;
    ...
    function removeElement(pos: any) {
